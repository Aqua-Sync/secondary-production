...
saveRDS(global_predictions_metals, file = paste0("posteriors/global_predictions_metals_",continent,".rds"))

# summarize ---------------------------------------------------------------
global_predictions_metals = readRDS(file = paste0("posteriors/global_predictions_metals_",continent,".rds"))
