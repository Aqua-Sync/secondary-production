...
# This code generates aquatic concentrations of contamiants. First,load X_jeff.rds. These are contaminant 
# concentrations from Jakob on seafile.rlp.net...then reformat. mean.conc.year is the mean, mean.det.year is detection. 
selenium_predictions_all = readRDS("data/selenium_jeff.rds") %>% 
